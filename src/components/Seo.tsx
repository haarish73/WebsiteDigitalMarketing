...
import { Search, TrendingUp, BarChart3, FileText, Link2, Award, Target, Zap, CheckCircle, ArrowRight } from 'lucide-react';
...
export default function SEOServicesPage() {
  ...
  const seoServices = [
    ...
    { 
      ...
      description: 'Track rankings, traffic, and ROI with detailed insights',
      color: '#4ECDC4' 
    },
  ];
  ...
  const process = [
    ...
    { step: '02', title: 'Strategy Development', description: 'Custom SEO roadmap tailored to your goals' },
    { step: '03', title: 'Implementation', description: 'Execute on-page, off-page, and technical optimizations' },
    { step: '04', title: 'Monitor & Optimize', description: 'Continuous tracking and improvement of results' },
  ];
        ...
        <section className="py-24 px-4">
          <div className="container mx-auto">
            ...
            <p className="text-xl text-gray-400 text-center mb-16 max-w-2xl mx-auto">
              Comprehensive SEO services designed to boost your online visibility and drive organic growth
            </p>

...
import { Zap, Target, TrendingUp, Users, Award, BarChart3, MessageCircle, Sparkles } from 'lucide-react';
...
export default function DigitalMarketingWebsite() {
  ...
  const services = [
    { id: 'seo', icon: TrendingUp, title: 'SEO Optimization', description: 'Boost your rankings and organic traffic', color: '#FF6B6B' },
    { id: 'social', icon: Users, title: 'Social Media Marketing', description: 'Engage audiences across all platforms', color: '#4ECDC4' },
    { id: 'ppc', icon: Target, title: 'PPC Advertising', description: 'Maximize ROI with targeted campaigns', color: '#FFE66D' },
    { id: 'content', icon: MessageCircle, title: 'Content Marketing', description: 'Compelling content that converts', color: '#A8E6CF' },
    { id: 'analytics', icon: BarChart3, title: 'Analytics & Insights', description: 'Data-driven decision making', color: '#FF6B6B' },
    { id: 'branding', icon: Award, title: 'Brand Strategy', description: 'Build a memorable brand identity', color: '#4ECDC4' },
  ];

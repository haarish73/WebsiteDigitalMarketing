    ...
    <div className="w-full bg-black">
      ...
      <div className="relative w-full bg-black">
       ...
       <div className="w-full py-4 overflow-hidden whitespace-nowrap flex items-center"
        ...
        {/* Stats Section */}
        <section className="w-full bg-black py-16" data-section="stats">
        ...
        {/* Services Section */}
        <section id="services" className="w-full bg-black py-24" data-section="services">
          <div className="container mx-auto px-6">
        ...
        {/* SERVICES SECTION */}
        <section id="services" className="w-full bg-black py-24" data-section="services2">
          <div className="container mx-auto px-6">
            {/* Header */}
        ...
        {/* FREE QUOTE SECTION */}
        <section className="w-full bg-black py-24" data-section="quote">
          <div className="container mx-auto px-6">
        ...
        {/* CTA Section */}
        <section className="w-full bg-black py-24" data-section="cta">
          <div className="container mx-auto px-6">
            <div 
        ...
        {/* Footer */}
        <footer className="w-full bg-black border-t border-white/10 py-12" data-section="footer"
          style={{
